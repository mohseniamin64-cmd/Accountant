...
> **تکمیل وضعیت Cloudflare (2026-09-25):** نوع اتصال تأییدشده Cloudflare Tunnel است. پس از نصب Windows، `cloudflared` و تنظیم تونل را دوباره نصب/اعمال کنید. اگر تونل فایل اعتبارنامه محلی دارد، آن را پیش از پاک‌سازی در محل امن نگه دارید؛ یا با حساب Cloudflare تونل را بازسازی کنید. رازها را در Git/chat نگذارید.

> **اصلاح وضعیت (2026-09-25):** مالک تأیید کرد نوع اتصال Cloudflare Tunnel است. جمله قبلی که می‌گفت Cloudflare نصب نشده، نادرست است. پس از نصب Windows، `cloudflared` و تنظیمات تونل دوباره نصب/اعمال می‌شوند. پیش از پاک‌سازی، اگر تنظیم از فایل محلی/اعتبارنامه استفاده می‌کند آن‌ها را امن نگه دارید؛ در غیر این صورت با حساب Cloudflare تونل را بازسازی کنید. نام تونل و دامنه هنوز ثبت نشده‌اند.
