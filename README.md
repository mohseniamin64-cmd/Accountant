...
> **تکمیل وضعیت Cloudflare (2026-09-25):** مالک مشخص کرد اتصال از نوع Cloudflare Tunnel است. پس از نصب Windows باید `cloudflared` و تنظیم Tunnel دوباره نصب/اعمال شود. نام تونل و دامنه هنوز ثبت نشده‌اند.

> **اصلاح وضعیت (2026-09-25):** مالک پروژه تأیید کرد Cloudflare Tunnel روی کامپیوتر فعلی استفاده می‌شود. عبارت پایین‌تر که می‌گوید Cloudflare راه‌اندازی نشده، قدیمی/نادرست است. پس از نصب ویندوز، `cloudflared` و تنظیم تونل باید دوباره نصب/اعمال شوند. نام تونل و دامنه هنوز ثبت نشده‌اند. برای توضیح ساده اصطلاحات شبکه: [واژه‌نامه شبکه](NETWORK-GLOSSARY.md).
