...
هنوز سرور عملیاتی شرکت وجود ندارد: یک کامپیوتر فعلی محیط توسعه/آزمایش است و موقتاً برنامه روی آن اجرا می‌شود. n8n نصب‌شده در Docker برای آزمون اتوماسیون‌هاست، نه سرویس وابسته برنامه حسابداری. کاربرد فعلی شبکه داخلی است؛ Cloudflare یا انتقال به دسترسی بیرونی فقط گزینه آینده است و راه‌اندازی نشده.
