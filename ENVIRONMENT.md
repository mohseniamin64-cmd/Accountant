...
> **تکمیل وضعیت Cloudflare (2026-09-25):** نوع اتصال تأییدشده Cloudflare Tunnel است. `cloudflared` روی کامپیوتر فعلی نصب/تنظیم شده؛ نام تونل، دامنه و روش مدیریت تنظیمات هنوز مستند نشده‌اند.

> **اصلاح وضعیت (2026-09-25):** مالک پروژه تأیید کرد Cloudflare Tunnel استفاده می‌شود. `cloudflared` روی کامپیوتر فعلی نصب/تنظیم شده؛ نام تونل، دامنه و روش مدیریت تنظیمات محلی هنوز مستند نشده‌اند.
