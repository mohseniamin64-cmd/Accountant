...
> **اصلاح وضعیت (2026-09-25):** مالک پروژه تأیید کرد Cloudflare روی کامپیوتر فعلی نصب شده است. جمله قبلی درباره نصب‌نشدن Cloudflare قدیمی/نادرست است. نوع اتصال/تونل هنوز در این سند معلوم نیست و باید پیش از نوشتن دستور بازیابی دقیق مشخص شود.
